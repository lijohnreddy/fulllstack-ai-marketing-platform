...
function PromptContainerCard({
  ...
  useEffect(() => {
    ...
    setIsExceeded(newTokenCount > MAX_TOKENS_PROMPTS);
  }, [prompt]);
    ...
    >
      <CardContent className="p-4 sm:p-6 sm:px-8">
        <div className="flex items-center justify-between">
          <div className="flex items-center grow min-w-0 space-x-2">
            <MessageSquare
              className="h-4 w-4 sm:h-6 sm:w-6 text-main shrink-0"
              strokeWidth={3}
            />
