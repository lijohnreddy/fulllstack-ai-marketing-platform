...
// import ManageUploadStep from "../ManageUploadStep";
// import ConfigurePromptsStep from "../ConfigurePromptsStep";
...
function ProjectDetailView({ project }: projectDetailViewProps) {
  ...
  return (
    <div className="mxa-w-screen-xl mx-auto p-4 sm:p-6 lg:p-8 bg-white space-y-12">
      <ProjectDetailHeader
        project={project}
      ...
      <ProjectDetailStepper
        ...
        steps={steps}
      />
      <div className="bg-gray-100 rounded-2xl p-4 sm:p-6 lg:p-8 shadow-sm mt-10 sm:mt-12 lg:mt-10">
        <ProjectDetailBody
          currentStep={currentStep}
          steps={steps}
      ...
      {/* TODO: CONFIRM DELETE isDeleting=*/}
      <ConfirmationModel
