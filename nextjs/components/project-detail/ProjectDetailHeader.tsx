...
function ProjectDetailHeader({
  ...
  // TODO: useState for title & edit title
  const handleTitleSubmit = async () => {
    try {
      ...
      const defaultMessage = "Failed to update title. Please try again.";
  ...
  // TODO: Save the title to DB function
  // TODO: create a PUT/PATCH/POST request endpoint for project changes
  // TODO: Create Dlete request endpoint  for project deletion
    ...
    return (
      <div className="flex flex-col sm:flex-row items-start sm:items-center space-y-2 sm:space-y-0 space-x-0 sm:space-x-2 w-full">
        ...
        <Input
          ...
          className="p-0 border-gray-300 bg-gray-50 text-2xl sm:text-3xl lg:text-4xl font-bold text-gray-900 w-full focus:outline-none focus-visible:ring-0 focus-visible:ring-offset-0"
        />
        {/* ACTION BUTTONS*/}
        <Button
  ...
  {
    /* if edition, show edit screen. otherwise, show read screen */
  }
  return (
